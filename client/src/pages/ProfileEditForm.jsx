...
<div className='col-sm-3'>
  <div id='editprofileimg' className='card'>
    ...
    <input
        ...
        type="file"
      />
      <div className='d-grid gap-2 text-center mt-1'><Button variant = 'contained'onClick={handleImgEdit} className='uploadbutton'>Upload</Button></div>
  </div>
...
<br />
  ...
  <div className='d-grid gap-2 text-center mt-4'><Button variant="contained" disabled={!fName|| !address || !phone|| !bloodType} onClick={handleEditProfile} >SUBMIT</Button></div>
  </div>
